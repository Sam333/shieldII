...
--	end
	...
	mp = s:taboption("advanced", ListValue, "Wsc_mode", translate("WPS Mode"))
	mp:value("", translate("disable"))
	mp:value("WPS PBC", translate("WPS PBC"))
	mp:value("WPS PIN", translate("WPS PIN"))
	ml = s:taboption("advanced", Flag, "WPS_PBC", translate("WPS PBC"))
	ml:depends({Wsc_mode="WPS PBC"})
	ml = s:taboption("advanced", Value, "WPS_PIN", translate("WPS PIN"))
	ml:depends({Wsc_mode="WPS PIN"})
